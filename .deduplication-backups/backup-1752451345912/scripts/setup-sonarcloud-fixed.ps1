...
function Show-VSCodeSettings {
    Write-Host "VS Code Settings Location:" -ForegroundColor Green
...
function Test-Integration {
    ...
    if (Test-Path ".github/workflows/quality-monitoring.yml") {
        ...
        if ($content -match "sonarcloud-github-action") {
            ...
            Write-Host "! SonarCloud action not found in workflow" -ForegroundColor Yellow
        }
    } else {
    ...
    if (Test-Path "package.json") {
        ...
        if ($packageJson.scripts."test:coverage") {
            ...
            Write-Host "! Coverage script not found in package.json" -ForegroundColor Yellow
        }
    }
...
function Show-Documentation {
    ...
    if (Test-Path "docs/infrastructure/SONARCLOUD_SETUP_GUIDE_COMPLETE.md") {
        ...
        Write-Host "ERROR: Documentation not found!" -ForegroundColor Red
    }
}
